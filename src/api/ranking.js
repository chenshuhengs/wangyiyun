...
// 删除评论
export const getCommentDelete = params => axios.get(`/comment?t=${params.t}&type=${params.type}&id=${params.id}&commentId=${params.commentId}`)
...
// 相似MV
export const getSimiMv = params => axios.get(`/simi/mv?mvid=${params.id}`)
